...
SEARCH_URL = "https://jobs.rogers.com/search"
BASE_URL = "https://jobs.rogers.com"
PAGE_SIZE = 10
...
def _try_json_api() -> list[dict]:
    ...
    try:
        ...
        logger.warning(f"Rogers JSON API failed: {e}")
        return []
    return jobs
...
def _try_html_scrape() -> list[dict]:
    ...
    try:
        ...
        logger.warning(f"Rogers HTML scrape failed: {e}")
    return jobs
